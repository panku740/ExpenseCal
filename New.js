        ...
        <ScrollView>
          ...
          <Content style={{ marginLeft: 3, marginRight: 3 }}>
            <Card style={{ flex: 1 }}>
              ...
              <CardItem style={{ width: '90%', alignSelf: 'center' }}>

                <Body >
                  <Form style={{ width: '99%', marginLeft: '-10%', paddingRight: 20 }}>
                    ...
                    <CardItem>
                      <Left>
                        ...
                        <Item rounded style={{ margin: 5, height: 40, width: '70%' }}>
                    ...
                    <CardItem>
                      <Left>
                        ...
                        <Item rounded disabled style={{ margin: 5, height: 40, width: '20%' }}>
                    ...
                    <CardItem>
                      <Left>
                        ...
                        <Item picker style={{ margin: 5, height: 40, width: '70%' }}>
                          <Picker
                            mode="dropdown"
                    ...
                    <Item rounded style={{ marginLeft: 50, height: 40 }}>
                    ...
                    <CardItem>
                      <Left>
                        ...
                        <Item rounded style={{ margin: 5, height: 40, width: '70%' }}>
                          ...
                          <Input require keyboardType='numeric' placeholder='Amount' />
                        </Item >
